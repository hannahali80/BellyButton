...
// }
  ...
  var firstmetaSample = metadata_SelId[0];
  console.log(firstmetaSample); 

  // Create variables that hold the otu_ids, otu_labels, and sample_values.
  var otuIds = firstmetaSample.otu_ids;
  var otuLabels = firstmetaSample.otu_labels;
  var sampleValues = firstmetaSample.sample_values;
  console.log(otuIds);
  console.log(otuLabels);
  console.log(sampleValues);
